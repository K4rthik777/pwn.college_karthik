...
### Solve
**Flag:** `pwn.college{o_uKMHH-Im6dV2tovhaF6xwDJBL.QXwgDN1wSN1gjNzEzW}`
 for this Challenge , i ran /challenge/hack with | pipe operator with tee command along with >(/challenge/the) and >(/challenge/planet) to get the flag.

```bash 
hacker@piping~writing-to-multiple-programs:~$ /challenge/hack | tee >(/challenge/the) >(/challenge/planet)
This secret data must directly and simultaneously make it to /challenge/the and
/challenge/planet. Don't try to copy-paste it; it changes too fast.
10092205582642613710
Congratulations, you have duplicated data into the input of two programs! Here
is your flag:
pwn.college{o_uKMHH-Im6dV2tovhaF6xwDJBL.QXwgDN1wSN1gjNzEzW}
```

### New Learnings
I learned how >(command) can be to create named piped file to hook up multiple commands' input from another command's output with the help of tee command .
...
### Solve
**Flag:** `pwn.college{Uh80y8XTN15eQ8y_4G8am5wU4w0.QXxQDM2wSN1gjNzEzW}`
 for this Challenge , i ran /challenge/hack with | pipe operator with > >(/challenge/the) and 2> >(/challenge/planet) to get the flag.

```bash 
hacker@piping~split-piping-stderr-and-stdout:~$ /challenge/hack > >(/challenge/planet)  2> >(/challenge/the)
Congratulations, you have learned a redirection technique that even experts
struggle with! Here is your flag:
pwn.college{Uh80y8XTN15eQ8y_4G8am5wU4w0.QXxQDM2wSN1gjNzEzW}
```

### New Learnings
I learned how > >(command) and 2> >(command) can be used to redirect the stdout and stderr of a particular command as input for specified commands.
...
### Solve
**Flag:** `pwn.college{wmwbRTCbkkiflXIg5oAZBSwaWfR.01MzMDOxwSN1gjNzEzW}`
 for this Challenge , i created a named pipe file /tmp/flag_fifo and then ran /challenge/hack with > /tmp/flag_fifo.Finally catted the /tmp/flag_fifo in another terminal to get the flag.
...
pwn.college{wmwbRTCbkkiflXIg5oAZBSwaWfR.01MzMDOxwSN1gjNzEzW}
```

### New Learnings
I learned how mkfifo command can be used to create named pipes and how these named pipes have to used as they have both read and write modes open simultaneously so each respective command have to be run at the same time as well (mostly using two terminals).
